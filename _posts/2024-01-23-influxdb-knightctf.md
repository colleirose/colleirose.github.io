...
<br/><br/>
<img src="/assets/img/challenge fluxx.webp" alt="Challenge named &quot;Fluxx&quot; with description &quot;Recently I have made a simple app for monitoring and analyzing metrics, events, and real-time data. I used a database which is designed for handling high volumes of timestamped data. But I think its vulnerable find it and get the flag&quot;" loading="lazy">
...
<br/><br/>
<img loading="lazy" src="https://cdn.discordapp.com/attachments/1194841726163095565/1198507422340358154/image.png" alt="Response headers showing X-Powered-By: Express"/>
...
<img src="/assets/img/influxdb knightctf challenge console output.webp" loading="lazy" alt="Console output"/>

So I went back to Burp Suite and tried it again with the K

<img src="/assets/img/burp suite influxdb knightctf.webp" loading="lazy" alt="Burp Suite output showing the flag as KCTF{gOUPqVWa0eUT2wF2ipzX3v5pxikvqYhxR9oL}"/>
...
<img src="/assets/img/fluxx challenge correct.webp" loading="lazy" alt='Challenge showing "Correct" message after submitting flag'/>
